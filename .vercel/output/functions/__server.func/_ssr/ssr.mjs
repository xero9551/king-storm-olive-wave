...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-99Ck0eRR.mjs");
...
var manifest = {
	"768a2195be0112a6ae56f9633c77dcf914456d1bb9f8e138d1409a813e64132b": {
		functionName: "sendWebhook_createServerFn_handler",
		importer: () => import("./send-webhook-xPk-8xVx.mjs")
	},
	"e962c966dfe36461e048fd69e5ab767099c5177d049adaf384c59e44c0258f18": {
		functionName: "pollKev_createServerFn_handler",
		importer: () => import("./poll-kev-H_nyXXYB.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BwySQpKL.mjs").then((n) => n.t),
